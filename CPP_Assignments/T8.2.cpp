...
/*________________________________________________________________________________________________________
    ...
    Task(8.2): Extra Prefix sum:
    ----------------------------

        Write a C++ program to sort an array of integers in ascending order using function
        pointers. Allow the user to choose between different sorting algorithms 
        (e.g., bubble sort, selection sort) using function pointers.
