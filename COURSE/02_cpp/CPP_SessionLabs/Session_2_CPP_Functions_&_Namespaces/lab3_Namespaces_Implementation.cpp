...
// Implementations
// Can be done with scope operator like this:
void Calculator::Welcome(void) { std::cout << "Welcome to Calculator Function Overloading Demo!\n"; }
// Can be done inside the namespace in another place like this:
namespace Calculator
{
    // Overloading by parameter type
    ...
    // Overloading by parameter order
    double Mix(double a, int b) { return a + b + 0.1; }
    double Mix(int a, double b) { return a + b + 0.2; }
    // Other operations
    double Sub(double a, double b) { return a - b; }
    double Div(double a, double b) { return a / b; }
    double Multiply(double a, double b) { return a * b; }
    double Rem(double a, double b) { return static_cast<int>(a) % static_cast<int>(b); }
}
